...
(define-public go-github-com-andybalholm-cascadia
  (package
    ...
    (description
     "The Cascadia package implements CSS selectors for use with the parse
...
(define-public go-github-com-aws-aws-sdk-go-v2-service-ssooidc
  (package
    ...
    (description
     "Package ssooidc provides the API client, operations, and parameter types
for AWS SSO OIDC.")
    (license license:asl2.0)))
...
(define-public go-github-com-emersion-go-sasl
  (package
    ...
    (version "0.0.0-20241020182733-b788ff22d5a6")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1072khf8p8slgxhiijfs3ja253g8776av3jixv46almblyspnabs"))))
    (build-system go-build-system)
    (arguments
     (list
...
(define-public go-github-com-foxcpp-go-mockdns
  (package
    ...
    (description
     "This package provides Golang boilerplate for testing code involving DNS
lookups, including hacks to redirect @code{net.Lookup*} calls.")
    (license license:expat)))
...
(define-public go-github-com-google-go-containerregistry
  (package
    ...
    (synopsis "Go library and tools for working with container registries")
    (description
     "This package provides a Go library for interacting with container
registries.  It includes tools like @code{crane} for interacting with remote
images and registries, @code{gcrane} for GCR-specific operations, and
libraries for building and manipulating container images.")
    (license license:asl2.0)))
...
(define-public go-github-com-googleapis-gax-go-v2
  (package
    ...
    (description
     "This package contains a set of modules which aid the development of APIs
...
(define-public go-github-com-hashicorp-go-metrics
  (package
    (inherit go-github-com-armon-go-metrics)
...
(define-public go-github-com-pion-turn-v5
  (package
    (inherit go-github-com-pion-turn-v4)
    (name "go-github-com-pion-turn-v5")
    (version "5.0.2")
    (source
     (origin
       (method git-fetch)
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1vllx7iyi32acbdph7pcqwxhzfrcb2zap4jvwl0kny5jy5h023sy"))))
    (arguments
     (substitute-keyword-arguments (package-arguments
                                    go-github-com-pion-turn-v4)
       ((#:import-path _) "github.com/pion/turn/v5")))
    (propagated-inputs
     (list go-github-com-pion-logging
           go-github-com-pion-randutil
           go-github-com-pion-stun-v3
...
;; git-bug fails to build with the latest
;; go-gitlab-com-gitlab-org-api-client-go. So, we package this version. See
;; the git-bug package for details.
(define-public go-gitlab-com-gitlab-org-api-client-go-0.116
  (hidden-package
   (package
     ...
     (arguments
      (substitute-keyword-arguments
          (package-arguments go-gitlab-com-gitlab-org-api-client-go)
