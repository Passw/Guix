...
(define-public attica
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "007yi4yhi9lkxp78ga1rkdd47zw8rk6j9z634b29ba2bh0lalx12"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs (list qtbase))
...
(define-public karchive
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "17dm9l62cjail6paf9p7zbqhiiff15ir9fr2zbidbwqzlp84n9c4"))))
    (build-system cmake-build-system)
    (arguments
...
(define-public kdbusaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1a9h52dn8vb6a1d1appfm6g2y7309n0m4adyarnci5yirn202zvr"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public kdnssd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1acmc8fpr551qxk8nzi1xwzmdy3xn9yxsxmgh0jibm6rkk4g1vav"))))
    (build-system cmake-build-system)
    (native-inputs
  ...
  (package
    ...
    (source (origin
              ...
              (uri (string-append
                    ...
                    name "-" version ".tar.xz"))
              (sha256
               (base32 "1456w3jg7354qiphqnij9izpmzr0rvgac67sbciaxifn2g3z3drr"))))
    (build-system cmake-build-system)
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "0bianj6rw1wzgg3s5aqw8mvd9zsiqmabm7aa1xkvm18p696bl087"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
...
(define-public kirigami
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1yndwwkirf4bd6kkyb1mbwrv2hmqdxkk07csvxdrqqhrb5jma8h6"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:phases
...
(define-public kitemviews
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1pzg6273bgsshlq7r0zsnhinyck74h79266y4yixaq7brm7j0i4h"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments (list #:qtbase qtbase))
...
(define-public kwidgetsaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0jvmxh5d3jkns66zvc3cgsdmfrnpp1qvm6c23qjd6kh5jz32m0z8"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments
...
(define-public kwindowsystem
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "15ai1q4ph6jgs3xwl3gw8qifd8w9s4k6ynybmk9d8xsfhn9dl898"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules
           pkg-config
...
(define-public networkmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0vhf71ndgih37vc0gbgkdjdpmq1nqc023vv6k766sjcnvkaw4ykh"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules dbus pkg-config))
    (inputs (list qtbase))
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "16ikwhm9wlb0wxqkdjj8y1rnks8ykcl62rx5spdzibdx0wk6j3f4"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1bhzp0l26dlnfva9kijxzcc3f9k75zbg9n6f9v1d8a1phy060y5h"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public solid
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1wsvkc8bd6d9gd3qq545ggph0an6cjm5wq26qjjkdg1a5ra325a1"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public sonnet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1n40zs0rxgv64wm1fwmnlq20n0yg3a1r7z5kzw8fw4vfcrvw9zf8"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs
     (list extra-cmake-modules pkg-config qttools))
...
(define-public kcompletion
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0hgzwzmsi927qq4jgh83izmy9bg103rhz688056a6kg01i5j9wqv"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kdoctools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "049zdbbci6awxvn771abrzhc7m0kqhzknmqvkm99l7cyixsz54yq"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kimageformats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0wr0i9rcj76w455nigpazwz45kv4jv6bvpmgx31k6jxafnddxvnn"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public kpackage
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0sq010ia01jsx6h6ywqnh593cgxsm4f5b1744qm6xfj7sfra16yz"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (propagated-inputs (list kcoreaddons))
...
(define-public kpty
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0qwn1cfasp8p1pfs67b5izpgqq52da69y4w2ax4gpl89wqvawx79"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kdeclarative
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1rsbik17vkn3d1hfix9fa90qry68cb9cv46bjs3izp3c23d9fnh5"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kdesu
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0kw6c9cjqzrjaqrn1pkhx484rnjxqpsjljlw02js17rx2ni4fnav"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kpty))
    (native-inputs
