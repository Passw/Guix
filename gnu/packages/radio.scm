...
airspy front end or sdrplay device.  Since 3.0, it comes with acarsserv to
store received acars messages.")
...
(define-public radio-tool
  (package
    ...
    (description
     "@emph{radio_tool} is a utility for reading, writing, and manipulating
